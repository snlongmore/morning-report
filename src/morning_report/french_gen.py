"""French content generation via the Anthropic API.

Makes a single API call to generate all French learning content for the
...
def generate_french_content(
    ...
    """Generate all French learning content via a single Anthropic API call.
